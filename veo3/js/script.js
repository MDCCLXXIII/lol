...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById("generateBtn").addEventListener("click", () => {
    ...
    const deskripsiKarakter = document
      .getElementById("deskripsi_karakter")
      .value.trim();
    const suaraKarakter = document
      .getElementById("suara_karakter")
      .value.trim();
    const aksiKarakter = document.getElementById("aksi_karakter").value.trim();
    const ekspresiKarakter = document
      .getElementById("ekspresi_karakter")
      .value.trim();
    ...
    const suaraLingkungan = document
      .getElementById("suara_lingkungan")
      .value.trim();
...
Gerakan kamera yang digunakan adalah ${gerakanKamera} (${
      cameraMovements[gerakanKamera]
    }), diambil secara sinematik untuk menangkap setiap momen dengan indah.
**Desain Suara:**
